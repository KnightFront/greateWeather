...
const KEY = '8020d1ec41f64e66bd022de477680f69'   //和风天气中应用的key名称
const USER_ID = 'HE2006191401371543' //和风天气中应用的密钥ID

const WECHAT_APPID = 'wxa863a187d6f2a42b'
const WECHAT_APP_SECRET = 'b7bd705fb45991e6469e742571518619'
const $ = {
  getWechatAppConfig: () => {
    return {
      id: WECHAT_APPID,
